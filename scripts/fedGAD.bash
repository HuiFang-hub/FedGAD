...
#            # 构造参数字符串
#            # 调用程序，并将参数传递给它
#            echo "python fedsage+god_test.py --cfg yamlFile/fedsage+god.yaml federate.client_num $client_num dataloader.batch_size $batch_size train.optimizer.lr $lr"
#            python fedsage+god_test.py --cfg yamlFile/fedsage+god.yaml federate.client_num $client_num dataloader.batch_size $batch_size train.optimizer.lr $lr
#        done
#    done
#done
...
#  python fedGAD.py --cfg yamlFile/fedsage+god.yaml data.type "cora-inj-before" seed $seed data.type $data_type
#done
#done
...
#            for seed in {1..3};do
#      python fedGAD.py --cfg yamlFile/fedsage+god.yaml device 4 federate.method local data.type $data_type federate.client_num $client_num federate.method "fedAnemone" seed $seed data.anomaly_type $anomaly_type
#done
#done
#done
#done
