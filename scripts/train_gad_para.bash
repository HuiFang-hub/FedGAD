...
#      python train_gad_para.py  --cfg yamlFile/train_dag_para.yaml device 5 federate.method fedsagegod federate.client_num 3 data.anomaly_type 'cs' dataloader.batch_size 100 fedsageplus.fedgen_epoch 20 data.type $data_type seed 5 model.alpha $alpha
#done
#done
#
#
...
#      python train_fedsage.py  --cfg yamlFile/train_main.yaml device 0 federate.method local data.type $data_type federate.client_num $client_num federate.method fedsagegod seed $seed data.anomaly_type $anomaly_type dataloader.batch_size 100
#done
#done
#done
#done