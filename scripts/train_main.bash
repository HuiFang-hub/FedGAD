...
#      for anomaly_type in "${anomaly_types[@]}"; do
#          for seed in "${seeds[@]}";do
#      python train_fedsage.py  --cfg yamlFile/train_main.yaml device 5 data.type $data_type federate.client_num $client_num seed $seed data.anomaly_type $anomaly_type dataloader.batch_size $batch_size
#done
#done
#done
#done
...
#      for anomaly_type in "${anomaly_types[@]}"; do
#          for seed in "${seeds[@]}";do
#      python train_fedsage.py  --cfg yamlFile/train_main.yaml device 5 federate.method fedsagegod data.type $data_type federate.client_num $client_num federate.method fedsagegod seed $seed data.anomaly_type $anomaly_type dataloader.batch_size 100
#done
#done
#done
#done
