...
#      python fedCola.py --cfg yamlFile/fed_cola.yaml device 0 federate.method local data.type $data_type federate.client_num $client_num federate.method $condition seed $seed data.anomaly_type $anomaly_type
#done
#done
#done
#done
...
#          for anomaly_type in "${anomaly_type[@]}"; do
#            for seed in {11..13};do
#      python fedCola.py --cfg yamlFile/fed_cola.yaml device 3 federate.method local data.type $data_type federate.client_num $client_num federate.method $condition seed $seed data.anomaly_type $anomaly_type
#done
#done
#done
#done
...
#        python train_local.py --cfg yamlFile/train_local.yaml device 5 data.splitter 'random_partition' federate.method local data.type $data_type federate.client_num $client_num federate.method local seed $seed data.anomaly_type cs dataloader.batch_size $batch_size
#done
#done
#done
#done
