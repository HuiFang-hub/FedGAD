...
#      for seed in {5..7};do
#        cmd="python train_local.py --cfg yamlFile/train_local.yaml device 5 data.splitter 'random_partition' federate.method local data.type $data_type federate.client_num $client_num federate.method local seed $seed data.anomaly_type cs dataloader.batch_size $batch_size"
#        echo "$cmd"
#done
#done
#done
