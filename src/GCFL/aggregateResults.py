...
if __name__ == '__main__':
    ...
    parser.add_argument('--inpath', type=str, default='outputs/seqLen5/multiDS-nonOverlap/molecules/eps_0.07_0.28/repeats/',
                        help='The input path of the experimental results.')
    parser.add_argument('--outpath', type=str, default='outputs/seqLen5/multiDS-nonOverlap/molecules/eps_0.07_0.28/',
                        help='The out path for outputting.')
    parser.add_argument('--data_partition', type=str, default='oneDS',
