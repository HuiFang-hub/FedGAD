...
from  src.federatedscope.core.configs.yacs_config import CfgNode, _merge_a_into_b, \
    Argument
...
from src.federatedscope.core.configs import all_sub_configs

for sub_config in all_sub_configs:
    __import__("src.federatedscope.core.configs." + sub_config)

from src.federatedscope.contrib.configs import all_sub_configs_contrib

for sub_config in all_sub_configs_contrib:
    __import__("src.federatedscope.contrib.configs." + sub_config)
