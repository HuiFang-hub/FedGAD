# src.federatedscope-GNN: Towards a Unified, Comprehensive and Efficient Package for Federated Graph Learning
...
* Link-level tasks, please refer to `src.federatedscope/gfl/baseline/repro_exp/link_level/`:
