...
# python src.federatedscope/Fed_example.py --cfg \
# src.federatedscope/gfl/baseline/mini_graph_dc/fedavg.yaml --client_cfg \
# src.federatedscope/gfl/baseline/mini_graph_dc/fedavg_per_client.yaml
# Test Accuracy: ~0.7

# --cfg src/federatedscope/gfl/baseline/mini_graph_dc/fedavg.yaml
# --client_cfg   src/federatedscope/gfl/baseline/mini_graph_dc/fedavg_per_client.yaml
...
def load_mini_graph_dt(config, client_cfgs=None):
    ...
    from src.federatedscope.core.splitters.graph.scaffold_lda_splitter import \
        GenFeatures
    from src.federatedscope.core.data import DummyDataTranslator
